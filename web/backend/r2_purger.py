...
parser = argparse.ArgumentParser(description="Purge all objects from a Cloudflare R2 bucket.")
parser.add_argument("--force", action="store_true", help="Bypass confirmation prompts and delete immediately.")
...
# Confirm before proceeding - bypass if --force is used
if not args.force:
...
try:
    ...
    # Final confirmation with count - bypass if --force is used
    if not args.force:
        ...
        print(f"\nFound {object_count} objects. Proceeding with deletion due to --force flag.")
